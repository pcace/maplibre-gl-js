...
//#endregion
//#region src/source/geojson_taper.d.ts
/**
...
declare class LineTaperLayoutArray extends StructArrayLayout1f4 {}
...
declare class LineBucket implements Bucket {
  ...
  addLine(vertices: Point$1[], feature: BucketFeature, join: string, cap: string, miterLimit: number, roundLimit: number, canonical: CanonicalTileID | undefined, subdivisionGranularity: SubdivisionGranularitySetting, ringIndex?: number): void;
  /**
...
type LinePaintProps = {
  ...
  "line-width-start": DataDrivenProperty<number>;
  "line-width-end": DataDrivenProperty<number>;
  "line-widths": DataDrivenProperty<number[]>;
  "line-width-factors": DataDrivenProperty<number[]>;
};
type LinePaintPropsPossiblyEvaluated = {
  ...
  "line-gradient": ColorRampProperty;
  "line-width-start": PossiblyEvaluatedPropertyValue<number>;
  "line-width-end": PossiblyEvaluatedPropertyValue<number>;
  "line-widths": PossiblyEvaluatedPropertyValue<number[]>;
  "line-width-factors": PossiblyEvaluatedPropertyValue<number[]>;
};
//#endregion
