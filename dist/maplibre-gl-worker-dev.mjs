...
*/
import { B as PbfReader, Br as warnOnce, D as SymbolBucket, Dt as AlphaImage, G as buildTaperRegistry, Gi as Point, Ht as CollisionBoxArray, I as potpack, In as removeProtocol, K as GeoJSONVT, Mn as makeRequest, On as getArrayBuffer, Ot as RGBAImage, P as ImageAtlas, Pn as addProtocol, S as createStyleLayer, Sr as mapObject, Vn as JSON_PREFIX, W as annotateGeoJSONTileFeature, Wr as EXTENT, ar as ensureError, bn as groupByLayout, br as isWorker, c as FeatureIndex, d as DictionaryCoder, ft as VectorTile, g as OverscaledTileID, hn as createExpression, hr as isImageBitmap, i as clipGeometry, kn as getJSON, l as MLTVectorTile, m as fromVectorTileJs, n as performSymbolLayout, nn as EvaluationParameters, o as BoundedLRUCache, on as register, p as GeoJSONWrapper, pr as getImageData, rn as rtlWorkerPlugin, sr as extend, x as Actor, xt as DEMData, yn as featureFilter, zn as isAbortError } from "./maplibre-gl-shared-dev.mjs";
...
*/
var TaperGeoJSONWrapper = class extends GeoJSONWrapper {
	feature(i) {
		const feature = super.feature(i);
		const annotation = this.features[i]._taper;
...
var GeoJSONWorkerSource = class {
	...
	*/
	loadVectorTile(params) {
		...
		if (this._taperRegistry) for (const tileFeature of geoJSONTile.features) annotateGeoJSONTileFeature(tileFeature, params.tileID.canonical, this._taperRegistry);
		const geojsonWrapper = new TaperGeoJSONWrapper(geoJSONTile.features, {
			version: 2,
			extent: EXTENT
		});
		return {
